...
function Post({ id, post, postPage }) {
    ...
    onClick={()=> router.push(`/${id}`)}>  
      {/* option chaining which means if there's no post then it'll 
            display down the image */}
...
export default Post;
// stopPropagating is used over here to prevent routing over to another page